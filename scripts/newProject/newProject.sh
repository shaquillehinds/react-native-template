...
sed "s/reactNativeTemplate/$name/g" reactNativeTemplate/android/app/src/main/java/com/reactnativetemplate/MainActivity.kt > $name/android/app/src/main/java/com/$lowerName/MainActivity.kt
# ios/Podfile
